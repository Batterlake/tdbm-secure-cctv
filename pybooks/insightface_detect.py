...
def _detect_person(img, detector):
...
def person_detect(image, detector):
    img = image.copy()
    bboxes, vbboxes = _detect_person(img, detector)
    ...
    #     color = (255, 0, 0)
    #     for c in range(3):
    #         img[vy1:vy2, vx1:vx2, c] = img[vy1:vy2, vx1:vx2, c] * alpha + color[c] * (
    #             1.0 - alpha
    #         )
